module student_nfts::nfts {
    ...
    public struct StudentIdCard has key, store {
        id: UID,
        name: String,
        student_id: String,
        course: String,
    ...
    public struct EventPass has key, store {
        id: UID,
        event_name: String,
        date: String,
        venue: String,
    ...
    public struct AttendanceReport has key, store {
        id: UID,
        student_name: String,
        subject: String,
        percentage: String,
    ...
    public struct BunkPass has key, store {
        id: UID,
        student_name: String,
        reason: String,
        date: String,
    ...
    public struct HostelComplaint has key, store {
        id: UID,
        student_name: String,
        room_no: String,
        issue: String,
